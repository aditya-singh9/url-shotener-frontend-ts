...
function URLShortenerForm() {
  ...
  const getForksStarsCount = async () => {
    const { data } = await axios.get(
      `https://api.github.com/repos/aditya-singh9/url-shotener-frontend-ts`
    );
        ...
        <div className="outer">
          ...
          <div className="forks_stars_div">
            <div className="block_div">
              <a
                className="btn"
                href="https://github.com/aditya-singh9/url-shotener-frontend-ts"
                rel="noreferrer noopener"
                target="_blank"
                aria-label="Fork aditya-singh9/kekfinder on GitHub"
              >
                <div className="block_divLeft">
                  <StarBorderIcon className="starbtn" />
                  <p className="forks_stars_text">Star</p>
                </div>
              </a>
            ...
            <div className="block_div">
              <a
                className="btn"
                href="https://github.com/aditya-singh9/url-shotener-frontend-ts/fork"
                rel="noreferrer noopener"
                target="_blank"
                aria-label="Fork aditya-singh9/kekfinder on GitHub"
              >
          ...
          <div className="outer">
            <form className="form" onSubmit={handleSubmit}>
              <input
                ...
                value={destination}
              />
              <div className="clearBtn" onClick={clearText}>
                <ClearIcon></ClearIcon>
              </div>
